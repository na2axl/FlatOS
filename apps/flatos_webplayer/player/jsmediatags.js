        ...
        onSuccess: function () {
          self._loadData(self._mediaFileReader, {
            onSuccess: function () {
              ...
              callbacks.onSuccess(tags, self._mediaFileReader._url);
            },
            onError: function (p) {
                callbacks.onError(p, self._mediaFileReader._url);
            }
          });
        },
        onError: callbacks.onError
...
var mediaFileReaders = [XhrFileReader, BlobFileReader];
var mediaTagReaders = [ID3v2TagReader, ID3v1TagReader, MP4TagReader];
